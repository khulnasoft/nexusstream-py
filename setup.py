...
with open('nexusstream/__init__.py', 'r') as f:
    for line in f:
...
kwargs = {
    ...
    'author': 'Giao Phan',
    'author_email': 'giao@khulnasoft.com',
    'maintainer': 'Giao Phan',
    'maintainer_email': 'giao@khulnasoft.com',
    'url': 'https://github.com/khulnasoft/nexusstream-py',
    'license': 'MIT',
    'classifiers': [
